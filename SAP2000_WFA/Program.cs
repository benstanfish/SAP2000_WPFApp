    ...
    static class Program
    {
        ...
        static void Main()
        {
            ...
            */
            ...
            int shellCount = mySapModel.AreaObj.Count();

            ret = mySapModel.AreaObj.GetNameList(ref shellCount,ref shellNames);
        ...
        /*
        public static void KillSap(cOAPI sapObject, cSapModel aSapModel)
        {
